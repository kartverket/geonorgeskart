...
//>>built
define("dojo/_base/declare dojo/_base/lang dojo/_base/html dojo/_base/array dojo/on dojo/aspect jimu/BaseWidgetPanel jimu/BaseWidgetFrame jimu/utils ./FoldableDijit ./FoldableWidgetFrame".split(" "), function(h, c, b, e, g, k, l, m, n, p, q) {
    return h([l, p], {
        ...
        getPanelPosition: function() {
            ...
            var a = c.clone(this.position);
            "undefined" === typeof a.width && (a.width = 360);
            "minimized" === this.windowState ? (a.bottom = "auto", a.height = this.titleHeight, a.borderRadiusStyle = {
                ...
                this.position.bottom, a.height = "auto", a.borderRadiusStyle = {
                    borderTopLeftRadius: "4px",
                    borderTopRightRadius: "4px",
        ...
        resize: function() {
            ...
            var d = n.getPositionStyle(a);
            c.mixin(d, a.borderRadiusStyle);
            b.setStyle(this.domNode, d);
        ...
        _switchParentNode: function() {
            window.appInfo.isRunInMobile &&
                this.domNode && this.domNode.parentNode !== b.byId(jimuConfig.layoutId) ? b.place(this.domNode, jimuConfig.layoutId) : !window.appInfo.isRunInMobile && (this.domNode && this.domNode.parentNode !== b.byId(this.map.id)) && b.place(this.domNode, this.map.id)
        },
        _setFrameSize: function(a) {
            ...
            d = (a - (this.getChildren().length - f) * this.getChildren()[0].titleHeight) / f;
            e.forEach(this.getChildren(),
                function(a) {
                    a.folded ? b.setStyle(a.domNode, {
                        height: a.titleHeight + "px"
                    }) : b.setStyle(a.domNode, {
                        height: d + "px"
                    });
                    a.resize()
                }, this)
        ...
        createCloseBtn: function() {
            this.closeNode = b.create("div", {
                "class": "close-btn jimu-float-trailing"
            }, this.titleNode);
            this.own(g(this.closeNode, "click", c.hitch(this, function(a) {
                a.stopPropagation();
                this.panelManager.closePanel(this)
            })))
        },
        createMaxBtn: function() {
            this.maxNode = b.create("div", {
                "class": "max-btn jimu-float-trailing"
            }, this.titleNode);
            this.own(g(this.maxNode, "click",
        ...
        createFrame: function(a) {
            this.config.widgets && 1 === this.config.widgets.length || !this.config.widgets ? a = new m : (a = new q({
                label: a.label,
                widgetManager: this.widgetManager
            }), k.after(a, "onFoldStateChanged", c.hitch(this, function() {
                var a = 0;
                this._setFrameSize();
        ...
        onMaxNodeClick: function() {
            "maximized" === this.windowState ? this.panelManager.normalizePanel(this) : this.panelManager.maximizePanel(this)
        },
        moveTitle: function() {
            this.isFull ? this.folded ? b.setStyle(this.domNode, {
                top: b.getMarginBox(jimuConfig.layoutId).h - this.titleHeight + "px"
